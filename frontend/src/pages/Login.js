...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      await axios.post('http://localhost:5000/user/sign-in', {
        username: username,
        password: password
      });
    ...
    <div className='login-home-container d-flex flex-row row'>
      ...
      <div className='d-flex col-lg-4 col-md-6 col-sm login-form'>
        ...
        <div className='container-md-6 container-sm-4 d-flex flex-column'>
          <button type='button' className='btn btn-outline-secondary m-2 p-2' onClick={loginWithGoogle}>
            <div className='d-flex align-items-center justify-content-center'>
              <img src='./google_logo.png' className='d-block mx-2' alt='google_logo.png' />
              <p className='m-0 p-0'>Sign in with Google</p>
            </div>
          </button>
          <button type='button' className='btn btn-outline-secondary m-2 p-2' onClick={loginWithFacebook}>
            <div className='d-flex align-items-center justify-content-center'>
